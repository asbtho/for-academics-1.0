...
<table class="widefat">
	<td>
		...
		<form action="#" method="post">	
			...
			<p><input type="submit" name="np-updated" value="Update publication"></p>
		</form>
	</td>
</table>
...
function update()
{
    echo "Updated ".$_POST["np-title"]."<br/>";
}

if(isset($_POST['np-updated']))
{
   update();
   editPub();
} 
...
jQuery(document).ready(function($) {
	$('#np-type').val(<?php echo "'".$_POST["np-type"]."'"; ?>);
	showFields();
